...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'employees.login_length' => 'integer',
...
'database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','employees.login_length','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./var/www/public/storage','jwt.secret','jwt.keys.public','jwt.keys.private',
...
'verification.send','logout','storage.local',);
...
'FRONTEND_URL','AUTH_GUARD','AUTH_PASSWORD_BROKER','APP_LOCALE','APP_FALLBACK_LOCALE',
